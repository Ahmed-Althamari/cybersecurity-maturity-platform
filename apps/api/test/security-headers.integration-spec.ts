 ...
 * drops `helmet()` from test-app.ts/main.ts's shared config would
 ...
 * fixes. Boots the real AppModule like tenant-security.integration-spec.ts
 * and checks a real HTTP response's headers directly.
 */
