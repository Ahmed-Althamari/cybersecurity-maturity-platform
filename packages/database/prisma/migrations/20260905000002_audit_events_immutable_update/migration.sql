...
-- ever updates an audit_events row (grep confirms it -- AuditService only
-- ever exposes record/findAll/findOne), so this is a purely additive
-- guarantee with nothing to break. DELETE is a different story:
